...
<body>
  <form id="query-su" action="<?php echo U('Admin/Check/activityList');?>" method="post" target="query-show">
	...
	<iframe id="query-list" name="query-show"  src="<?php echo U('Admin/Check/activityList');?>" marginheight="0" marginwidth="0" frameborder="0" scrolling="no" width="100%" height="100%" onLoad="iFrameHeight()" >
