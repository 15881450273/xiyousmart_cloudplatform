...
<body>
	...
	<div id="check">
		<form id="checksubmit" action="<?php echo U('Admin/Check/activitycheckHandle');?>" method="post">
			<table class="checkform" >
				<tr>
				<td><a href="<?php echo U('Admin/check/checklist');?>">返回</a></td>
				    <input type="hidden" name="uid" value="<?php echo ($uid); ?>"/>
				    <input type="hidden" name="aid" value="<?php echo ($activity["id"]); ?>"/>
					<td>审核结果</td>
					<td>
  	...
  	var options = {
                    ...
                    success:function(data){
                        if(data){
                            ...
                            window.location.href="<?php echo U('Admin/Check/activitylist');?>";
                        }
                        else {
                            var d = dialog({
                                content: '哎呀，提交失败啦-_-!'
