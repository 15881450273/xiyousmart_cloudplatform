...
<div class="page-header" style="width:1000px;margin:0 auto;">
  <h1 style="font-size:36px;"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> &nbsp;<?php if($editing == 1): ?>修改活动<?php else: ?>添加活动<?php endif; ?><small style="float:right;"> 党员发展评估系统</small></h1>
</div>
