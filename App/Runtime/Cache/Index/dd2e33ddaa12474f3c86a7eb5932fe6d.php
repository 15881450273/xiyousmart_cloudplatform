...
<div class="page-header" style="width:1000px;margin:0 auto;">
  <h1 style="font-size:36px;"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> &nbsp;<?php if($editing == 1): ?>修改活动<?php else: ?>添加活动<?php endif; ?><small style="float:right;">西柚智慧党建云平台</small></h1>
</div>
<form id="addActivity" action="<?php echo U('Index/Task/addActivityHandle');?>?type=1" method="post" class="definewidth m20" enctype="multipart/form-data">
